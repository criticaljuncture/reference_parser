RSpec.shared_examples "url examples" do
  describe "links urls" do
    ...
    scenerios_url = [
      ...
      {ex: '<a href="#">10 CFR 100</a>', result: '<a href="#">10 CFR 100</a>'},
      {ex: '<p><a href="#">10 CFR 100</a> and (<em>hi</em>) <em>alpha</em> beta 10 CFR 10 omega</p>', result: '<p><a href="#">10 CFR 100</a> and (<em>hi</em>) <em>alpha</em> beta <a href="https://www.ecfr.gov/current/title-10/part-10" class="cfr external">10 CFR 10</a> omega</p>'},
  ...
  it "handles trailing semicolons (path)" do
    url = "https://www.example.com/a-path/b-path;"
    url_result = generate_result(url.delete_suffix(";")) + ";"
    expect(hyperlink(url.to_s)).to eql url_result.to_s
  end
  ...
  it "handles EOL" do
    ...
    expect(hyperlink("<p>#{url1}<br />#{url2}<br /></p>")).to eql drop_zero_width_spaces_if_unexpected %(<p><a href="#{url1}">http://api.rubyonrails.com/&#8203;Foo.html</a><br /><a href="#{url2}">http://www.ruby-doc.org/&#8203;core/&#8203;Bar.html</a><br /></p>)
  end
  ...
  it "handles previously escaped input" do
    ...
    XML
    expect(result).to eql(drop_zero_width_spaces_if_unexpected(<<-XML))
      <E T="03">
